...
#-----------------------------------------------------------------------------
#Advanced statistical validation for ion NH4+
#==============================================================================
...
#Data configuration
#-----------------------------------------------------------------------------
CALIBRATION_FILE = 'NH4-training.xlsx'
THRESHOLD_GR = 2.3183 #at optimal concentration break-point (0.5 ppm for NH4+)

def advanced_validation():
    print("=" * 80)
    print("Advanced statistical validation for ion NH4+")
    print("=" * 80)
    ...
    try:
        ...
        #Creating dummy variables (based on G/R)
        df['D'] = (df['G_R'] > THRESHOLD_GR).astype(int)
        ...
        #If Delta < 0.1 is not overfitting, if Delta < 0.05 the model is extremely stable
        ...
        plt.title("Residuals vs Predicted Values (NH4+)")
